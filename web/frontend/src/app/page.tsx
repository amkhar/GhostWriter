                          ...
                          <div>
                            <div className="flex items-center justify-between gap-3 mb-2">
                              ...
                              <span className={`text-[10px] px-2 py-0.5 rounded font-mono font-bold uppercase ${
                                ...
                                a.status === 'working' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20 animate-pulse' :
                            ...
                            {a.branch && (
                              <div className="flex items-center gap-1 text-[10px] bg-slate-950/80 px-2.5 py-1.5 rounded-lg border border-slate-800/80 text-slate-400 font-mono select-all">
                                <svg className="w-3.5 h-3.5 text-slate-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 7.5a3 3 0 0 1 3-3h3.5m0 0A3 3 0 0 1 18 7.5v9a3 3 0 0 1-3 3h-3.5m0 0a3 3 0 0 1-3-3v-9Z" />
                                </svg>
                ...
                return (
                  <div key={i} className={`bg-slate-900/40 border rounded-xl p-5 shadow-sm ${r.success ? 'border-emerald-500/20' : 'border-rose-500/20'}`}>
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 font-mono">
                      ...
                      {r.branch && (
                        <span className="text-[10px] text-blue-400 font-mono select-all">Branch: {r.branch}</span>
                      )}
                    </div>
                    {r.diff && (
                      <div className="mt-3">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs font-mono text-slate-400">
            {agent.branch && (
              <div>
                ...
                <span className="text-blue-400 font-bold select-all truncate block">{agent.branch}</span>
              </div>
            )}
            {agent.test_status && (
              <div>
